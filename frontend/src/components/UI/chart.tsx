 ...
 * Maps theme names to CSS selectors
 */
const THEMES = { 
  light: "", 
  dark: ".dark" 
...
/**
 * Configuration type for chart series
 */
 ...
 * Provides context and styling for all chart elements
 */
...
/**
 * Generates CSS styles for chart colors
 */
...
/**
 * Enhanced legend content component
 */
...
export {
  ...
  ChartLegend,
  ChartLegendContent,
  useChart, // Export the hook for easier access
  type ChartConfig, // Export the type for usage in other files
}